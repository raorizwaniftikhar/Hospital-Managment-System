...
//    prnt($deprtment_data);
    if (!$errors) {
        if (isset($_GET['id'])) {
            updateData('services', $deprtment_data, ' where id = ' . $_GET['id']);
            $message = "your data is updated Successfully";
        } else {
            insertData('services', $deprtment_data);
            $message = "your data is saved Successfully";
        }
    }
}
if (isset($_GET['id'])) {
    $deprtment = getData('services', '*', 'where id = ' . $_GET["id"]);
...
<script type="text/javascript">
	...
	$(document).ready(function () {
        document.title = "Add/Edit Services: Admin Panel";
    });
</script>
<div class="content">
    <div class="header">
