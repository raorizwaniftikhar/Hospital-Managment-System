...
<script type="text/javascript">
 ...
 $(document).ready(function(){
	document.title = "Departments Page: Admin Panel"; 
 });
</script>
<div class="content">
    <div class="header">
                    ...
                    <div class="tab-pane active in" id="home">
                        <form id="home_form" action="" method="post">
                            <div class="form-group">
                                <label>Heading</label>
                                <input type="text" name="heading" value="<?php echo $data[13]['name']; ?>" class="form-control">
                            </div>

                            <div class="form-group">
                                <label>Text</label>
                                <textarea name="text" value="" rows="10" class="form-control"><?php echo $data[13]['value']; ?></textarea>
                            </div>
                        </form>
                    </div>
